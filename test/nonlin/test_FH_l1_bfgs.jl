...
function FHNONLINl1LBFGS()
    ...
    savefig("figs/nonlin/FH/l1bfgs/fhn_basic.pdf")
    ...
    savefig("figs/nonlin/FH/l1bfgs/vdp_basic.pdf")
    ...
    sol = solve(myProbFH; reltol=1e-6, saveat = savetime, verbose=false)
    ...
    plot!(sol_VDP.t, data[1,:], label="V-data")
    plot!(sol_VDP.t, data[2,:], label="W-data")
    savefig("figs/nonlin/FH/l1bfgs/vcomp.pdf")
