export s_options, PG, PG!, FISTA, FISTA!, prox_split_1w, prox_split_2w, linesearch, ls, directsearch, directsearch!
...
function s_options(β;optTol=1f-6, maxIter=10000, verbose=0, restart=10, λ=1.0, η =1.0, η_factor=.9, Δ=1.0,
