...
#set all options
β = eigmax(A'*A)
Doptions=s_options(β; maxIter=100, λ=k)
...
FO_options = Doptions, s_alg=hardproxB0Binf, InnerFunc=fval, χ_projector=projbox)
...
savefig("figs/bpdn/LS_B0_Binf/xcomp.pdf")
